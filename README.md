...
- `web` provides an image upload UI and calls `verify_image`; current fast-mode response is displayed as a summary (classification, score, reason codes, latency) plus raw JSON.
