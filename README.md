...
- `web` provides an image upload UI and calls `verify_image`; users can choose `Fast` (structured scaffold result) or `Deep` (explicit scaffold-limitation hint for not-implemented mode).
