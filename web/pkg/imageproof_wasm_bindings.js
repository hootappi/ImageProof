/* @ts-self-types="./imageproof_wasm_bindings.d.ts" */
 ...
 * @returns {any}
 */
export function verify_image(image_bytes, fast_mode) {
    const ptr0 = passArray8ToWasm0(image_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.verify_image(ptr0, len0, fast_mode);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./imageproof_wasm_bindings_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('imageproof_wasm_bindings_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
